	...
	if(htim==position_sensor_htim)
	{
		...
		else
		{
			...
			present_velocity_rad =
					ALPHA_VELOCITY * (delta_position_rad / (float)position_delta_time_us * 1000000.0f)
					+ (1.0f-ALPHA_VELOCITY) * present_velocity_rad;
			// save last position
